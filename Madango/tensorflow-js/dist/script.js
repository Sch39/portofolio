...
Promise.all([
    faceapi.nets.tinyFaceDetector.loadFromUri('/tensorflow-js/face-detection/models'),
    faceapi.nets.faceLandmark68Net.loadFromUri('/tensorflow-js/face-detection/models'),
    faceapi.nets.faceRecognitionNet.loadFromUri('/tensorflow-js/face-detection/models'),
    faceapi.nets.faceExpressionNet.loadFromUri('/tensorflow-js/face-detection/models')
]).then(startWebcam);
